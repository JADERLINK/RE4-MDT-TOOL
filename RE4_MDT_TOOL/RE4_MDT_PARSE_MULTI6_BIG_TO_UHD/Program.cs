...
namespace RE4_MDT_PARSE_MULTI6_BIG_TO_UHD
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("RE4_MDT_PARSE_MULTI6_BIG_TO_UHD");
        ...
        static void Action(string file)
        {
            ...
            var res = RE4_MDT_PARSE.ParseMDT.Parse_UHD_NS(stream, false, SimpleEndianBinaryIO.Endianness.BigEndian); //BIG
            stream.Close();

            var outputFileInfo = new FileInfo(outputFile);
            var outStream = outputFileInfo.OpenWrite();
            RE4_MDT_PARSE.MakeMDT.Make_UHD_BIG(res, outStream, SimpleEndianBinaryIO.Endianness.LittleEndian); //UHD
            outStream.Close();
        }
    }
}
