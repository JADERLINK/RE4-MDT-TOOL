...
namespace RE4_MDT_PARSE_UHD_TO_BIG_MULTI6
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("RE4_MDT_PARSE_UHD_TO_BIG_MULTI6");
        ...
        static void Action(string file)
        {
            ...
            RE4_MDT_PARSE.MakeMDT.Make_UHD_BIG(res, outStream, SimpleEndianBinaryIO.Endianness.BigEndian); //BIG
            outStream.Close();
        }
    }
}
