...
namespace RE4_MDT_PARSE_MONO_UHD_TO_PS4NS
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("RE4_MDT_PARSE_MONO_UHD_TO_PS4NS");
        ...
        static void Action(string file) 
        {
            ...
            RE4_MDT_PARSE.MakeMDT.MakeMono(res, outStream, 0, true, out _); // PS4NS
            outStream.Close();
        }
    }
}
