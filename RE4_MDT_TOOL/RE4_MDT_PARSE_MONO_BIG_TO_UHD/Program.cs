...
namespace RE4_MDT_PARSE_MONO_BIG_TO_UHD
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("RE4_MDT_PARSE_MONO_BIG_TO_UHD");
        ...
        static void Action(string file)
        {
            ...
            RE4_MDT_PARSE.MakeMDT.MakeMono(res, outStream, 0, false, out _, SimpleEndianBinaryIO.Endianness.LittleEndian); // UHD
            outStream.Close();
        }
    }
}
