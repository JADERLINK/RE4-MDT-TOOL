...
namespace RE4_MDT_SINGLE_MULTI_PS4
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("RE4_MDT_SINGLE_MULTI_PS4");
        ...
        static void Action(string file)
        {
            ...
            var res = RE4_MDT_PARSE.ParseMDT.ParseMono(stream, 0, stream.Length, true); //ps4
            stream.Close();

            var outputFileInfo = new FileInfo(outputFile);
            var outStream = outputFileInfo.OpenWrite();
            RE4_MDT_SINGLE_MULTI.MakeSingleMulti.MakeSingleMulti_PS4(res, outStream); //ps4
            outStream.Close();
        }
    }
}
