...
namespace RE4_MDT_PARSE_MONO_PS4NS_TO_UHD
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("RE4_MDT_PARSE_MONO_PS4NS_TO_UHD");
        ...
        static void Action(string file)
        {
            ...
            var res = RE4_MDT_PARSE.ParseMDT.ParseMono(stream, 0, stream.Length, true); // PS4NS
            stream.Close();

            var outputFileInfo = new FileInfo(outputFile);
            var outStream = outputFileInfo.OpenWrite();
            RE4_MDT_PARSE.MakeMDT.MakeMono(res, outStream, 0, false, out _); // UHD
            outStream.Close();
        }
    }
}
