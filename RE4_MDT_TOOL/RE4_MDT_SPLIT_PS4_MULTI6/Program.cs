...
namespace RE4_MDT_SPLIT_PS4_MULTI6
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("RE4_MDT_SPLIT_PS4_MULTI6");
        ...
        static void Action(string file)
        {
            ...
            RE4_MDT_SPLIT.MakeMultiToMono.MakeMultiToMono_All(res, true, outputFile, false);
        }
    }
}
