...
namespace RE4_MDT_SPLIT_BIG_MULTI6
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("RE4_MDT_SPLIT_BIG_MULTI6");
        ...
        static void Action(string file)
        {
            ...
            var res = RE4_MDT_PARSE.ParseMDT.Parse_UHD_NS(stream, false, SimpleEndianBinaryIO.Endianness.BigEndian); //Big Endian
            stream.Close();

            RE4_MDT_SPLIT.MakeMultiToMono.MakeMultiToMono_All(res, false, outputFile, false, SimpleEndianBinaryIO.Endianness.BigEndian);
        }
